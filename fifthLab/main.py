...
linkToJPG = 'C:\\Users\\DNS\\PycharmProjects\\-ComputerGraphicsLabs\\frog_diffuse.jpg'
linkToOBJ = 'C:\\Users\\DNS\\PycharmProjects\\-ComputerGraphicsLabs\\frog_v1_L3.obj'
scale = 1
width = 2000
height = 500
...
def rotate_and_shift(vertex):
    ...
    new_coord = np.add(new_coord, np.array([1, 1, 100]))
...
vertices, edges, textures, textures_coords = parse_obj(linkToOBJ)
...
def printTriangle(image, x0nch, y0nch, z0, x1nch, y1nch, z1, x2nch,y2nch, z2, z_buffer, ax, ay, I0, I1, I2, indexPlg, F1, F2, F3,rgb_img):
...
img_mat = np.full((height, width, 3), (255, 255, 255), dtype=np.uint8)
...
img.save('FrogWithTextureWithScale=1and2000HA500.png')
